...
//line /home/vrjoshi/proj/caravan-flow/zinc-flow-go/src/core/result.zn:5
type Single struct {
	Ff FlowFile
}
...
//line /home/vrjoshi/proj/caravan-flow/zinc-flow-go/src/core/result.zn:6
...
//line /home/vrjoshi/proj/caravan-flow/zinc-flow-go/src/core/result.zn:7
type Routed struct {
	Route string
	Ff FlowFile
}
...
//line /home/vrjoshi/proj/caravan-flow/zinc-flow-go/src/core/result.zn:8
type Dropped struct {
	Reason string
}
...
//line /home/vrjoshi/proj/caravan-flow/zinc-flow-go/src/core/result.zn:9
type Failure struct {
	Reason string
	Ff FlowFile
}

...
public final class Metrics {
    ...
    public Metrics() {
        ...
        this.ingested = Counter.builder("caravanflow_ingested_total")
                .description("Total FlowFiles accepted at any source")
                .register(registry);
        this.dropped = Counter.builder("caravanflow_dropped_total")
    ...
    void recordProcessed(String processor) {
        processorCounts.computeIfAbsent(processor, p ->
                Counter.builder("caravanflow_processor_processed_total")
    ...
    void recordFailed(String processor) {
        processorErrors.computeIfAbsent(processor, p ->
                Counter.builder("caravanflow_processor_errors_total")

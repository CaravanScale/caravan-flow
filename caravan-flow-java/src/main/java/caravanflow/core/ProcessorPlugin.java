...
/// with a {@code META-INF/services/caravanflow.core.ProcessorPlugin} entry
/// listing fully qualified class names, and the caravan-flow-java
/// {@link caravanflow.fabric.PluginLoader} registers each one under its
/// {@link #type()} with the {@link caravanflow.fabric.Registry}.
///

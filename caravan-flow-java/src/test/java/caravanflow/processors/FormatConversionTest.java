...
final class FormatConversionTest {
    ...
    void avroRoundTripNestedRecordAndArray() {
        ...
        Schema nested = SchemaBuilder.record("Order").namespace("caravanflow").fields()
                .name("id").type().stringType().noDefault()
                .name("items").type().array().items().stringType().noDefault()
                .name("customer").type().record("Customer").namespace("caravanflow").fields()
        ...
        var raw = (caravanflow.core.RawContent) encoded.flowFile().content();

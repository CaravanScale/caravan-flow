...
///   2. Environment variable (<c>ZINCFLOW_CONFIG_LOCAL</c>,
///      <c>ZINCFLOW_SECRETS_PATH</c>).
...
public static class Overlay
{
    ...
    public const string EnvLocal = "ZINCFLOW_CONFIG_LOCAL";
    public const string EnvSecrets = "ZINCFLOW_SECRETS_PATH";

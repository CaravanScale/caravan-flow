...
public static class E2ETests
{
    ...
    static void TestE2EContentStoreLifecycle()
    {
        ...
        var tmpDir = Path.Combine(Path.GetTempPath(), $"caravan-e2e-content-{Environment.TickCount64}");
        try
        {
    ...
    static void TestE2EListenHTTPPipeline()
    {
        ...
        var tmpDir = Path.Combine(Path.GetTempPath(), $"caravan-e2e-http-{Environment.TickCount64}");

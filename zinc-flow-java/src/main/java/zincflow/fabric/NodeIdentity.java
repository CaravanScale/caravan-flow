...
/// {@link zincflow.providers.UIRegistrationProvider} sends to the UI.
///
...
///   <li>UUID persisted to {@code ./zincflow.nodeId} on first boot.
...
public final class NodeIdentity {
    ...
    public static final String NODE_ID_FILE = "zincflow.nodeId";
